...
<body>
    ...
    <nav class="nav-1">
        <div class="max-width">
            <div class="flex">
                <ul class="menu-item">
                    <li style=" background-color: #FA7758;"><a href="../index.php" class="item">Women</a></li>
                    <li><a href=" MEN.php" class="item">Men</a></li>
                    <li style="background-color: #fff;"><a href="#" class="item" style="color: #000;">Kids</a></li>
                </ul>
                <div>
    ...
    <nav class="nav-2">
        <div class="max-width">
            <div class="flex-2 flex-item">
                <div class="logo">
                    <a href="KID.php"><img src="../assets/img/Kids/logo-kids.png" alt=""></a>
                </div>
                <ul class="hidden">
                    <li><a href="KID.php">Home</a></li>
