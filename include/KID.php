...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/Kids.css?<?php echo time(); ?>">
...
<body>
        ...
        <div class="max-width">
            <div class="flex">
                <ul class="menu-item">
                    ...
                    <li><a href="MEN.php" class="item">Men</a></li>
                    <li><a href="#" class="item" style="color: #000;">Kids</a></li>
                </ul>
                <div>
    ...
    <nav class="nav-2">
        <div class="max-width">
            <div class="flex-2 flex-item">
                <div class="logo">
                    <a href="index.php"><img src="../assets/img/Kids/logo-kids.png" alt=""></a>
                </div>
                <ul class="hidden">
                    <li><a href="">Home</a></li>
                ...
                <ul class="margin">
                    ...
                    <li><a href="KidSignIn.php"><img src="../assets/img/user.png" alt=""></a></li>
    ...
    <section class="trendBtn">
        <div class="trendBx">
            <div class="trend-grid">
                ...
                <div class="trend_Bx-1">
                    <img src="../assets/img/Kids/n-8.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="collection">
        <div class="coll_grid">
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <img src="../assets/img/Kids/n-3.jpg" alt="">
                <p><a href="#">all possimus</a></p>
                <p><a href="#">cosmopolis</a></p>
                <p><a href="#">suito</a></p>
                <p><a href="#">milancelos</a></p>
            ...
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <img src="../assets/img/Kids/n-4.jpg" alt="">
                <p><a href="#">all possimus</a></p>
                <p><a href="#">cosmopolis</a></p>
                <p><a href="#">suito</a></p>
                <p><a href="#">milancelos</a></p>
            ...
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <img src="../assets/img/Kids/n-5.jpg" alt="">
                <p><a href="#">all possimus</a></p>
                <p><a href="#">cosmopolis</a></p>
                <p><a href="#">suito</a></p>
                <p><a href="#">milancelos</a></p>
            ...
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <img src="../assets/img/Kids/n-6.jpg" alt="">
                <p><a href="#">all possimus</a></p>
                <p><a href="#">cosmopolis</a></p>
                <p><a href="#">suito</a></p>
                <p><a href="#">milancelos</a></p>
            ...
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <img src="../assets/img/Kids/n-7.jpg" alt="">
                <p><a href="#">all possimus</a></p>
                <p><a href="#">cosmopolis</a></p>
                <p><a href="#">suito</a></p>
                <p><a href="#">milancelos</a></p>
    ...
    <section class="newInBtn">
        ...
        <div class="new_grid-1">
            <div class="new_Bx-1">
                <img src="../assets/img/Kids/n-1.jpg" alt="">
            </div>
            <div class="new_Bx-1">
                <img src="../assets/img/Kids/n-2.jpg" alt="">
            </div>
        </div>
    </section>
                            ...
                            <div class="card_1_imgBx">
                                ...
                                <div class="overlay">
                                    <form action="../controller/CartAction.php" method="POST">
                                        ...
                                        <button type="submit" name="kOrderBtn" class="buy-btn">Buy Now</button>
                                    </form>
                                </div>
                            </div>
    ...
    <section class="card-4">
        <div class="card-4_grid">
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-1.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">jackets</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-2.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">hoodies</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-3.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">casual</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-4.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">dresses</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-5.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">jeans</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-6.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">bags</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-7.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">shopes</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="../assets/img/Kids/c-8.webp" alt="">
                <div class="card-3_overlay">
    ...
    <section class="card-6">
        ...
        <div class="card-6_grid">
            <div class="card-6_box-1">
                <a href="#"><img src="../assets/img/Kids/k-1.webp" alt=""></a>
                <a href="#"><img src="../assets/img/Kids/k-2.webp" alt=""></a>
                <a href="#"><img src="../assets/img/Kids/k-3.webp" alt=""></a>
                <a href="#"><img src="../assets/img/Kids/k-4.webp" alt=""></a>
            </div>
            <div class="card-6_box-2">
                <a href="#"><img src="../assets/img/Kids/k-5.webp" alt=""></a>
            </div>
            <div class="card-6_box-3">
                <a href="#"><img src="../assets/img/Kids/k-6.webp" alt=""></a>
                <a href="#"><img src="../assets/img/Kids/k-7.webp" alt=""></a>
                <a href="#"><img src="../assets/img/Kids/k-2.webp" alt=""></a>
                <a href="#"><img src="../assets/img/Kids/k-4.webp" alt=""></a>
            </div>
        </div>
                ...
                <div class="s-card-item">
                    <?php foreach ($result5 as $result5) { ?>
                        <div class="flexx">
                            ...
                            <div class="del">
                                <a href="../controller/CartAction.php?id3=<?php echo $result5['ID'] ?>"><i class="fas fa-trash"></i></a>
                            </div>
                        </div>
