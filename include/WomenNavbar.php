...
<body>
    ...
    <nav class="nav-1">
        <div class="max-width">
            <div class="flex">
                <ul class="menu-item">
                    <li><a href="../index.php" class="item" style="color: black;">Women</a></li>
                    <li><a href="MEN.php" class="item">Men</a></li>
                    <li><a href="" class="item">Kids</a></li>
                </ul>
                <div>
        ...
        <div class="max-width">
            <div class="flex-2 flex-item">
                ...
                <ul class="margin">
                    ...
                    <li><a href="include/SignIn.php"><img src="../assets/img/user.png" alt=""></a></li>
