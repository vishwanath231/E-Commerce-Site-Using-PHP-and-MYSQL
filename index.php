...
<body>
    ...
    <nav class="nav-1">
        <div class="max-width">
            <div class="flex">
                <ul class="menu-item">
                    <li><a href="#" class="item" style="color: black;">Women</a></li>
                    <li><a href="include/MEN.php" class="item">Men</a></li>
                    <li><a href="include/KID.php" class="item">Kids</a></li>
                </ul>
                <div>
    ...
    <nav class="nav-2">
        <div class="max-width">
            <div class="flex-2 flex-item">
                <div class="logo">
                    <a href="index.php"><img src="assets/img/Women/logo-new.png" alt=""></a>
                </div>
                <ul class="hidden">
                    <li><a href="">Home</a></li>
                ...
                <ul class="margin">
                    ...
                    <li><a href="include/WomenSignIn.php"><img src="assets/img/user.png" alt=""></a></li>
    ...
    <section class="trendBtn">
        <div class="trendBx">
            <div class="trend-grid">
                ...
                <div class="trend_Bx-1">
                    <img src="assets/img/Women/img-30.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="collection">
        <div class="coll_grid">
            <div class="coll_Bx-1">
                <img src="assets/img/Women/img-31.webp" alt="">
            </div>
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <p><a href="#">all possimus</a></p>
            ...
            <div class="coll_Bx-1">
                <img src="assets/img/Women/img-32.webp" alt="">
            </div>
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <p><a href="#">all possimus</a></p>
            ...
            <div class="coll_Bx-1">
                <img src="assets/img/Women/img-33.webp" alt="">
            </div>
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <p><a href="#">all possimus</a></p>
            ...
            <div class="coll_Bx-1">
                <img src="assets/img/Women/img-34.webp" alt="">
            </div>
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <p><a href="#">all possimus</a></p>
            ...
            <div class="coll_Bx-1">
                <img src="assets/img/Women/img-35.webp" alt="">
            </div>
            <div class="coll_Bx-1">
                <h2>possimus</h2>
                <p><a href="#">all possimus</a></p>
    ...
    <section class="newInBtn">
        ...
        <div class="new_grid-1">
            <div class="new_Bx-1">
                <img src="assets/img/Women/img-36.webp" alt="">
            </div>
            <div class="new_Bx-1">
                <img src="assets/img/Women/img-37.webp" alt="">
            </div>
        </div>
    </section>
                            ...
                            <div class="card_1_imgBx">
                                ...
                                <div class="overlay">
                                    <form action="controller/CartAction.php" method="POST">
                                        ...
                                        <button type="submit" name="orderBtn" class="buy-btn">Buy Now</button>
                                    </form>
                                </div>
                            </div>
    ...
    <section class="card-4">
        <div class="card-4_grid">
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-11.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">tops</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-12.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">bottoms</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-13.webp" alt="">
                <div class="card-3_overlay">
                    <a href="#">casual</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-14.jpg" alt="">
                <div class="card-3_overlay">
                    <a href="#">dresses</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-15.jpg" alt="">
                <div class="card-3_overlay">
                    <a href="#">formal</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-16.jpg" alt="">
                <div class="card-3_overlay">
                    <a href="#">swimwear</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-17.jpg" alt="">
                <div class="card-3_overlay">
                    <a href="#">shopes</a>
                </div>
            </div>
            <div class="card-4_imgBx">
                <img src="assets/img/Women/img-18.jpg" alt="">
                <div class="card-3_overlay">
    ...
    <section class="card-6">
        <div class="card-6_grid">
            <div class="card-6_box-1">
                <a href="#"><img src="assets/img/Women/img-21.jpg" alt=""></a>
                <a href="#"><img src="assets/img/Women/img-22.jpg" alt=""></a>
                <a href="#"><img src="assets/img/Women/img-23.jpg" alt=""></a>
                <a href="#"><img src="assets/img/Women/img-24.jpg" alt=""></a>
            </div>
            <div class="card-6_box-2">
                <a href="#"><img src="assets/img/Women/img-25.jpg" alt=""></a>
            </div>
            <div class="card-6_box-3">
                <a href="#"><img src="assets/img/Women/img-26.jpg" alt=""></a>
                <a href="#"><img src="assets/img/Women/img-27.jpg" alt=""></a>
                <a href="#"><img src="assets/img/Women/img-1.jpg" alt=""></a>
                <a href="#"><img src="assets/img/Women/img-9.jpg" alt=""></a>
            </div>
        </div>
    </section>
                ...
                <div class="s-card-item">
                    <?php foreach ($result5 as $result5) { ?>
                        <div class="flexx">
                            ...
                            <div class="del">
                                <a href="controller/CartAction.php?id1=<?php echo $result5['ID'] ?>"><i class="fas fa-trash"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="s-link">
                        <a href="#">check out</a>
                        <a href="include/ShoppingCart.php">view cart</a>
                    </div>
